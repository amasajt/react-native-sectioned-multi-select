...
class RowSubItem extends Component {
  ...
  render() {
    ...
    // Temporarily disable headers with ids greater than 10000
    // This is for project specific testing
    // TODO: Modify for generic use of additional levels
    // By: JTA
    const disableHeaders = (subItem[uniqueKey] > 10000)
    ...
    return (
      <View>
        ...
        >
          <TouchableOpacity
            disabled={disableHeaders || highlightChild || subItem.disabled}
